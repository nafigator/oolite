				...
				switch (kbd_event->keysym.sym) {
...
#endif
					case SDLK_1: keys[33] = YES; break;	// ! or 1
#if OOLITE_WINDOWS
					/*
					...
					*/
					...
					case SDLK_3:
						...
						break;
#else
					case SDLK_2: keys[64] = YES; break;	// @ or 2
					case SDLK_3: keys[35] = YES; break;	// # or 3
#endif
					case SDLK_4: keys[36] = YES; break;	// $ or 4
					case SDLK_5: keys[37] = YES; break;	// % or 5
					case SDLK_6: keys[94] = YES; break;	// ^ or 6
					case SDLK_7: keys[38] = YES; break;	// & or 7
					case SDLK_8: keys[42] = YES; break;	// * or 8
					case SDLK_9: keys[40] = YES; break;	// ( or 9
					case SDLK_0: keys[41] = YES; break;	// ) or 0
					...
					case SDLK_KP1: keys[gvNumberKey1] = YES; break;
					case SDLK_KP2: keys[gvNumberKey2] = YES; break;
					case SDLK_KP3: keys[gvNumberKey3] = YES; break;
					case SDLK_KP4: keys[gvNumberKey4] = YES; break;
					case SDLK_KP5: keys[gvNumberKey5] = YES; break;
					case SDLK_KP6: keys[gvNumberKey6] = YES; break;
					case SDLK_KP7: keys[gvNumberKey7] = YES; break;
					case SDLK_KP8: keys[gvNumberKey8] = YES; break;
					case SDLK_KP9: keys[gvNumberKey9] = YES; break;
					case SDLK_KP0: keys[gvNumberKey0] = YES; break;
...
keys[a] = NO; keys[b] = NO; \
				...
				*/
				...
				switch (kbd_event->keysym.sym) {
					...
					case SDLK_1: keys[33] = NO; break;		// ! and 1
#if OOLITE_WINDOWS
					/*
						Windows locale patch - fix shift-2 & shift-3
					*/
                    ...
                    case SDLK_3:
                        ...
                        break;
#else
					case SDLK_2: keys[64] = NO; break;	// @ or 2
					case SDLK_3: keys[35] = NO; break;	// # or 3
#endif
					case SDLK_4: keys[36] = NO; break;	// $ or 4
					case SDLK_5: keys[37] = NO; break;	// % or 5
					case SDLK_6: keys[94] = NO; break;	// ^ or 6
					case SDLK_7: keys[38] = NO; break;	// & or 7
					case SDLK_8: keys[42] = NO; break;	// * or 8
					case SDLK_9: keys[40] = NO; break;	// ( or 9
					case SDLK_0: keys[41] = NO; break;	// ) or 0
					...
					case SDLK_KP1: keys[gvNumberKey1] = NO; break;
					case SDLK_KP2: keys[gvNumberKey2] = NO; break;
					case SDLK_KP3: keys[gvNumberKey3] = NO; break;
					case SDLK_KP4: keys[gvNumberKey4] = NO; break;
					case SDLK_KP5: keys[gvNumberKey5] = NO; break;
					case SDLK_KP6: keys[gvNumberKey6] = NO; break;
					case SDLK_KP7: keys[gvNumberKey7] = NO; break;
					case SDLK_KP8: keys[gvNumberKey8] = NO; break;
					case SDLK_KP9: keys[gvNumberKey9] = NO; break;
					case SDLK_KP0: keys[gvNumberKey0] = NO; break;
